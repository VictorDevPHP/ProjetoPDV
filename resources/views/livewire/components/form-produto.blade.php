                ...
                <div class="row">
                    <div class="col-3">
                        <input class="form-control" name="nome" type="text" placeholder="Nome do Produto"
                            required="required" @if (isset($produto->nome)) value="{{ $produto->nome }}" @endif>
                    </div>
                    <div class="col-1">
                        <input class="form-control" name="preco" id="preco" type="number" min="0"
                            step="0.01" placeholder="Preço" required
                            @if (isset($produto->preco)) value="{{ $produto->preco }}" @endif>
                    </div>
                    <div class="col-3">
                        <input class="form-control" name="marca" type="text" placeholder="Marca"
                            required="required" @if (isset($produto->marca)) value="{{ $produto->marca }}" @endif>
                    </div>
                    <div class="col-2">
                        <input class="form-control" name="quantidade" type="number" placeholder="Quantidade"
                            required="required"
                            @if (isset($produto->quantidade)) value="{{ $produto->quantidade }}" @endif>
                    </div>
                </div>
            </div>
            <div class="row">
