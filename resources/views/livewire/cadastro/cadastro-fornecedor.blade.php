    ...
    <div class="container mt-4">
        ...
        <form method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="nome" placeholder="Digite o nome do Fornecedor" name="nome" required="required">
            </div>
            <div class="form-group">
                <label for="endereco">Endereço:</label>
                <input type="text" class="form-control" id="endereco" placeholder="Digite o Endereço" name="endereco" required="required">
            </div>
            <div class="form-group">
